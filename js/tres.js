...
function mostrar()
{
    ...
    switch(opcion)
    {
        case "api":
            ...
            localStorage['bienvenida'] = 'Transmite tus sentimientos con distinción y elegancia, exprésate con un detalle que contiene: 1 Canasta belen o 1 mi querido viejo , 1 globo por el costo de $60';
            valor = localStorage['bienvenida'];
            break;
        case "array":
            // Utilizar notación de matrices o arreglos
            localStorage['bienvenida'] = 'Para esa persona tan especial un detalle tierno y personal para impresionar, compuesto por: 1 caja con frutas, rosas y vino o 1 10 de mayo, mas globo con texto “feliz dia mamá”. Por un costo de $60';
            valor = localStorage['bienvenida'];
            break;
        case "object":
            ...
            'Compuesto por: 1 cono con rosas, 1 globo personalizado, 1 caja de chocolates. Por el costo de $50';
            valor = localStorage.bienvenida;
            break;
        default:
